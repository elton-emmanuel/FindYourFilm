...
public class ViewTicketForm extends javax.swing.JFrame {
    ...
    private void viewBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtnActionPerformed
        ...
        Ticket ticket = new Ticket( "Monday","Bad Bad Bad","Young and Dundas","8:00 PM","Regular","19+","PG");
        new TicketInfo(ticket).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTicketForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
